      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <p className="text-xl sm:text-2xl text-slate-300 max-w-2xl mx-auto">
            Junte-se a centenas de empresas que já transformaram visitantes em
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <Button
              size="lg"
              className="bg-white text-purple-950 hover:bg-muted font-bold px-10 py-7 text-lg rounded-full shadow-2xl transition-all hover:scale-105"
            >
