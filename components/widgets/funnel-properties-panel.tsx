                    ...
                    <>
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          value={(selectedWidget.content as { label?: string })?.label || ""}
                          onChange={(e) => handleUpdateContent("label", e.target.value)}
                        />
                      </div>
                      <div className="space-y-2">
                        <Label htmlFor="navigation-type">Tipo de navegação</Label>
                        <Select
                          value={(selectedWidget.content as { navigationType?: string })?.navigationType || ""}
                          onValueChange={(value) => handleUpdateContent("navigationType", value)}
                        >
                  ...
                  {selectedWidget.type === "texto" && (
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        id="text-content"
                        placeholder="Digite o texto"
                        value={(selectedWidget.content as { text?: string })?.text || ""}
                    ...
                    <>
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          max="100"
                          placeholder="0"
                          value={(selectedWidget.content as { value?: number })?.value || 0}
                          onChange={(e) => handleUpdateContent("value", Number(e.target.value))}
                        />
                      </div>
                      <div className="space-y-2">
                    ...
                    <>
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          min="0"
                          placeholder="60"
                          value={(selectedWidget.content as { duration?: number })?.duration || 60}
                          onChange={(e) => handleUpdateContent("duration", Number(e.target.value))}
                        />
                      </div>
                      <div className="space-y-2">
                  ...
                  {selectedWidget.type === "video" && (
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        id="video-url"
                        placeholder="https://..."
                        value={(selectedWidget.content as { url?: string })?.url || ""}
                  ...
                  {selectedWidget.type === "espaco" && (
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        min="0"
                        placeholder="20"
                        value={(selectedWidget.content as { height?: number })?.height || 20}
                        onChange={(e) => handleUpdateContent("height", Number(e.target.value))}
                      />
                    </div>
                  )}
                    ...
                    <>
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          value={(selectedWidget.content as { message?: string })?.message || ""}
                      ...
                      <div className="space-y-2">
                        ...
                        <Select
                          value={(selectedWidget.content as { type?: string })?.type || "info"}
                          onValueChange={(value) => handleUpdateContent("type", value)}
                        >
                          <SelectTrigger className="w-full">
                            <SelectValue placeholder="Selecione" />
                          </SelectTrigger>
                    ...
                    <>
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          id="price-currency"
                          placeholder="R$"
                          value={(selectedWidget.content as { currency?: string })?.currency || "R$"}
                          onChange={(e) => handleUpdateContent("currency", e.target.value)}
                        />
                      </div>
                    </>
                  )}
            ...
            <>
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) => handleUpdateStyle("borderRadius", value)}
                  disabled={!selectedWidget}
                >
                  <SelectTrigger className="w-full">
                    <SelectValue placeholder="Selecione" />
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) => handleUpdateStyle("fontSize", value)}
                  disabled={!selectedWidget}
                >
                  <SelectTrigger className="w-full">
                    <SelectValue placeholder="Selecione" />
          ...
          {activeTab === "exibicao" && (
            <>
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  <Input
                    ...
                    placeholder="0"
                    className="flex-1"
                    value={(selectedWidget?.content as { showDelay?: number })?.showDelay || 0}
                    onChange={(e) => handleUpdateContent("showDelay", Number(e.target.value))}
                    disabled={!selectedWidget}
                  />
                  <Select
                    value={(selectedWidget?.content as { showDelayUnit?: string })?.showDelayUnit || "seconds"}
                    onValueChange={(value) => handleUpdateContent("showDelayUnit", value)}
                    disabled={!selectedWidget}
                  >
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  <Input
                    ...
                    placeholder="0"
                    className="flex-1"
                    value={(selectedWidget?.content as { hideDelay?: number })?.hideDelay || 0}
                    onChange={(e) => handleUpdateContent("hideDelay", Number(e.target.value))}
                    disabled={!selectedWidget}
                  />
                  <Select
                    value={(selectedWidget?.content as { hideDelayUnit?: string })?.hideDelayUnit || "seconds"}
                    onValueChange={(value) => handleUpdateContent("hideDelayUnit", value)}
                    disabled={!selectedWidget}
                  >
                    <SelectTrigger className="w-[120px]">
                      <SelectValue placeholder="Unidade" />
              ...
              <div className="space-y-2">
                ...
                <Select
                  value={(selectedWidget?.content as { visibility?: string })?.visibility || "always"}
                  onValueChange={(value) => handleUpdateContent("visibility", value)}
                  disabled={!selectedWidget}
                >
                  <SelectTrigger className="w-full">
                    <SelectValue placeholder="Selecione" />
              ...
              <div className="space-y-2">
                ...
                <Select
                  value={(selectedWidget?.content as { animation?: string })?.animation || "none"}
                  onValueChange={(value) => handleUpdateContent("animation", value)}
                  disabled={!selectedWidget}
                >
                  <SelectTrigger className="w-full">
                    <SelectValue placeholder="Selecione" />
